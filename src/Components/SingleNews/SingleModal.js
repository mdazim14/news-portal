            ...
            <div className="border">
                <div className="text-dark d-inline-block">
                    <Card style={{ width: '80rem', height: '50rem' }}>
                        ...
                        <Card.Body>
                            <Card.Title>
                                <h1>{Title}</h1></Card.Title>
                            <Card.Text>
                                <div className="text-start">
                                    <h6>A court found Le Van Tri guilty of "transmitting dangerous infectious diseases" to eight people, one of whom eventually died.
                                        ...
                                        Many of those cases have been found in the capital Ho Chi Minh City.</h6>
